...
export default function HeaderTopBar() {
    ...
    return (
        <div className="flex px-4 py-4 items-center gap-3">

            {/* 1. COMPACT AVATAR */}
            <div className="h-10 w-10 shrink-0 rounded-xl bg-green-500 text-white flex items-center justify-center text-lg font-black shadow-sm overflow-hidden">
                {customer?.name[0] || "C"}
            </div>
            ...
            <div className="flex items-center gap-4 pr-1">
                ...
                <button
                    ...
                    className="relative flex items-center justify-center text-slate-900 hover:text-green-500 transition-colors"
                >
                ...
                >
                    ...
                    <div className={`
                        duration-700 rounded-full bg-green-500 absolute -top-1.5 -right-1.5 text-[9px] text-white font-black flex items-center justify-center border-2 border-white
