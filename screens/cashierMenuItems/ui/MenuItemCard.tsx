  ...
  return (
    ...
    >
      <div className="flex gap-4">
        {/* Image */}
        <div className="relative h-20 w-20 shrink-0 rounded-xl overflow-hidden bg-slate-100 border-gray-300 border">
          {menuItem.imageUrl ? (
            <Image
              fill
        ...
        <div className="flex flex-1 flex-col justify-between">
          <div>
            <div className="flex items-start justify-between gap-2">
              ...
              {/* Status Chip */}
              <span
                className={`rounded-full px-3 py-1 text-[10px] font-semibold ${isAvailable
          ...
          <div className="mt-3 flex items-center justify-between">
            ...
            <button
              ...
              className={`flex items-center gap-2 rounded-full px-3 py-2 cursor-pointer text-[10px] font-semibold transition active:scale-95 ${isAvailable
