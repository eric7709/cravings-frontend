            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div className="relative pt-8 pb-6 px-6 text-center">
                    <div className="relative inline-block">
                        <div className={`w-32 h-32 bg-linear-to-br ${getRoleColor(user.role as string)} rounded-full flex items-center justify-center shadow-xl ring-4 ring-white`}>
                    ...
                    <div className="inline-flex items-center gap-2 mt-3 px-4 py-2 bg-linear-to-r from-blue-50 to-cyan-50 rounded-full">
