...
export default function Header() {
  const { openCreateModal, search, setSearch } = useTableStore();
  ...
  return (
    <div className="px-4 py-3 bg-white border-b border-gray-100">
      ...
      <div className="hidden lg:flex bg-white items-center justify-between py-4 px-3 border border-gray-100 rounded-2xl shadow shadow-gray-200">
        <Search value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search Tables..." className="w-52" />
      ...
      <div className="lg:hidden">
        ...
        >
          ...
          <CreateButton title="Create Table" className="w-full justify-center" onClick={openCreateModal} />
        </div>
      </div>
    </div>
  );
