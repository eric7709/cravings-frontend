...
export default function Backdrop({ closeModal, modalOpened, children }: Props) {
    return (
        <div className={`h-dvh z-1000000 fixed left-0 duration-300 bg-blue-300/50 w-full grid place-content-center top-0 ${modalOpened ? "opacity-100 visible" : "opacity-0 invisible"}`}>
