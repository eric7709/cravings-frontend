      ...
      {items.map((item, idx) => (
        ...
        >
          <div className="flex items-center gap-3 flex-1 min-w-0">
            {/* Quantity badge */}
            <div className="h-6 w-6 rounded-full bg-green-700 flex items-center justify-center text-white font-bold text-xs shadow-sm">
              {item.quantity}
            </div>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {/* Price */}
            <span className="text-xs font-bold text-slate-900 min-w-17.5 text-right">
